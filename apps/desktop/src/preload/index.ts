...
const bridge: ElectronBridge = {
  ...
  listDeploymentWorkflows: () => ipcRenderer.invoke(IPC.LIST_DEPLOYMENT_WORKFLOWS),
  createDeploymentWorkflow: (input) => ipcRenderer.invoke(IPC.CREATE_DEPLOYMENT_WORKFLOW, input),
  updateDeploymentWorkflow: (input) => ipcRenderer.invoke(IPC.UPDATE_DEPLOYMENT_WORKFLOW, input),
  deleteDeploymentWorkflow: (name) => ipcRenderer.invoke(IPC.DELETE_DEPLOYMENT_WORKFLOW, name),
  getDeploymentWorkflow: (name) => ipcRenderer.invoke(IPC.GET_DEPLOYMENT_WORKFLOW, name),
  runDeploymentWorkflow: (input) => ipcRenderer.invoke(IPC.RUN_DEPLOYMENT_WORKFLOW, input),
